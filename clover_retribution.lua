...
local ThemeManager = (loadstring(game:HttpGet("https://pastebin.com/raw/4AmADeSZ")))()
local SaveManager = (loadstring(game:HttpGet("https://pastebin.com/raw/sxc2dYwb")))()
local Window = Library:CreateWindow({Title = timef("Cobb Hub Beta Scripts - %A, %B %d%o, %Y.", u0name),Center = true,AutoShow = true,TabPadding = 8,MenuFadeTime = 0,})
